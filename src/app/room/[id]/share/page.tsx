    ...
    return (
      <main className="flex min-h-screen flex-col items-center justify-center gap-6 bg-page px-4">
        ...
        <div className="text-center">
          <h1 className="mb-2 text-xl font-cute text-stone-900">방이 만료됐어요</h1>
          <p className="text-sm text-stone-600">보관 기간이 지나 초대 링크를 쓸 수 없어요.</p>
        </div>
        <Link
          href="/create"
          className="inline-flex min-h-11 items-center rounded-xl bg-amber-700 px-5 text-sm font-medium text-white transition-colors hover:bg-amber-800"
        >
          새 방 만들기
        </Link>
      </main>
